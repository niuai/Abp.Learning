...
namespace Jiabin.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See JiabinMigrationsDbContext for migrations.
     */
    ...
    public class JiabinDbContext : AbpDbContext<JiabinDbContext>
    {
         ...
         * Also map them inside JiabinDbContextModelCreatingExtensions.ConfigureJiabin
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the JiabinEfCoreEntityExtensionMappings class
                 */
            });
